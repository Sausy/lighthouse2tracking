...
/*  PulseOffsetFinder slowArea_pulseOffsetFinder (
  ...
  wire [16:0] ex_module_identifyer;
  wire [16:0] ex_module_identifyer2;
  assign ex_module_identifyer2 = ( temp_id3[4:2] << 1 ) | !temp_id3[2] ;
  assign ex_module_identifyer = ( ex_module_identifyer2 | 17'd0 );
  assign slowArea_identifiedBeamStream_payload = {{{{{{{slowArea_pulseIdentifier_io_pulseOut_payload_pulse_timestamp,(7'b0000000)},slowArea_pulseIdentifier_io_pulseOut_payload_beamWord},(7'b0000000)},ex_module_identifyer},slowArea_pulseIdentifier_io_pulseOut_payload_pulse_width},slowArea_pulseIdentifier_io_pulseOut_payload_npoly},temp_id3[1:0]};
