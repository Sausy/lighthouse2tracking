...
static void readRx_buffer( size_t size_max ){
  ...
  if(amount_of_data_rdy < DATA_LENGTH){
    //buffer_Cnt = 0;
      ...
      if(buffer_Cnt >= 12){
        ...
        while (buffer_Cnt > 0){
          ...
          */
          ...
          if((offset_temp & 0xffff00) == 0 && (offset_temp & 0x0000ff) != 0 && (beam_word_temp & 0x00007f) == 0 && (beam_word_temp & 0xffff00) != 0 && sensor_add >= 0 && sensor_add < 16 && timestamp_temp > 20){ // buffer[2]  >= 0xf0
            ...
            //buffer_Cnt = 0;
              ...
              xBit_block_udp = 0;
              for (size_t i = 0; i < buffer_Cnt; i=i+12) {
