...
(cl:defmethod cl:initialize-instance :after ((m <DirectionVector>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DirectionVector)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_cognition_msgs-msg:<DirectionVector> is deprecated: use roboy_cognition_msgs-msg:DirectionVector instead.")))

(cl:ensure-generic-function 'azimutal_angle-val :lambda-list '(m))
(cl:defmethod azimutal_angle-val ((m <DirectionVector>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_cognition_msgs-msg:azimutal_angle-val is deprecated.  Use roboy_cognition_msgs-msg:azimutal_angle instead.")
  (azimutal_angle m))

(cl:ensure-generic-function 'polar_angle-val :lambda-list '(m))
(cl:defmethod polar_angle-val ((m <DirectionVector>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_cognition_msgs-msg:polar_angle-val is deprecated.  Use roboy_cognition_msgs-msg:polar_angle instead.")
  (polar_angle m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DirectionVector>)))
  ...
  "roboy_cognition_msgs/DirectionVector")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DirectionVector)))
  "Returns string type for a message object of type 'DirectionVector"
  "roboy_cognition_msgs/DirectionVector")
