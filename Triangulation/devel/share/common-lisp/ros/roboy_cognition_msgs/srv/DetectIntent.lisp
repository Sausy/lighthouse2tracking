...
(cl:defmethod cl:initialize-instance :after ((m <DetectIntent-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectIntent-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_cognition_msgs-srv:<DetectIntent-request> is deprecated: use roboy_cognition_msgs-srv:DetectIntent-request instead.")))

(cl:ensure-generic-function 'sentence-val :lambda-list '(m))
(cl:defmethod sentence-val ((m <DetectIntent-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_cognition_msgs-srv:sentence-val is deprecated.  Use roboy_cognition_msgs-srv:sentence instead.")
  (sentence m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectIntent-request>)))
  ...
  "roboy_cognition_msgs/DetectIntentRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectIntent-request)))
  "Returns string type for a service object of type 'DetectIntent-request"
  "roboy_cognition_msgs/DetectIntentRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <DetectIntent-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectIntent-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_cognition_msgs-srv:<DetectIntent-response> is deprecated: use roboy_cognition_msgs-srv:DetectIntent-response instead.")))

(cl:ensure-generic-function 'intent-val :lambda-list '(m))
(cl:defmethod intent-val ((m <DetectIntent-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_cognition_msgs-srv:intent-val is deprecated.  Use roboy_cognition_msgs-srv:intent instead.")
  (intent m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <DetectIntent-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_cognition_msgs-srv:distance-val is deprecated.  Use roboy_cognition_msgs-srv:distance instead.")
  (distance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectIntent-response>)))
  ...
  "roboy_cognition_msgs/DetectIntentResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectIntent-response)))
  "Returns string type for a service object of type 'DetectIntent-response"
  "roboy_cognition_msgs/DetectIntentResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectIntent)))
  ...
  "roboy_cognition_msgs/DetectIntent")