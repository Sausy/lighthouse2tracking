...
(cl:defmethod cl:initialize-instance :after ((m <Behavior>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Behavior)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_control_msgs-msg:<Behavior> is deprecated: use roboy_control_msgs-msg:Behavior instead.")))
...
(cl:defmethod actions-val ((m <Behavior>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_control_msgs-msg:actions-val is deprecated.  Use roboy_control_msgs-msg:actions instead.")
  (actions m))
