...
(cl:defmethod cl:initialize-instance :after ((m <DangerNotification>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DangerNotification)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_control_msgs-msg:<DangerNotification> is deprecated: use roboy_control_msgs-msg:DangerNotification instead.")))
...
(cl:defmethod validity_duration-val ((m <DangerNotification>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DangerNotification>)))
  ...
  "roboy_control_msgs/DangerNotification")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DangerNotification)))
  "Returns string type for a message object of type 'DangerNotification"
  "roboy_control_msgs/DangerNotification")
