...
(cl:defmethod cl:initialize-instance :after ((m <DebugNotification>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DebugNotification)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_control_msgs-msg:<DebugNotification> is deprecated: use roboy_control_msgs-msg:DebugNotification instead.")))
...
(cl:defmethod validity_duration-val ((m <DebugNotification>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DebugNotification>)))
  ...
  "roboy_control_msgs/DebugNotification")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DebugNotification)))
  "Returns string type for a message object of type 'DebugNotification"
  "roboy_control_msgs/DebugNotification")
