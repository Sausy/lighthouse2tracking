...
(cl:defmethod cl:initialize-instance :after ((m <MoveYaw-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveYaw-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_control_msgs-srv:<MoveYaw-request> is deprecated: use roboy_control_msgs-srv:MoveYaw-request instead.")))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <MoveYaw-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_control_msgs-srv:value-val is deprecated.  Use roboy_control_msgs-srv:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MoveYaw-request>)))
  ...
  "roboy_control_msgs/MoveYawRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MoveYaw-request)))
  "Returns string type for a service object of type 'MoveYaw-request"
  "roboy_control_msgs/MoveYawRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <MoveYaw-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveYaw-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_control_msgs-srv:<MoveYaw-response> is deprecated: use roboy_control_msgs-srv:MoveYaw-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MoveYaw-response>)))
  ...
  "roboy_control_msgs/MoveYawResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MoveYaw-response)))
  "Returns string type for a service object of type 'MoveYaw-response"
  "roboy_control_msgs/MoveYawResponse")
