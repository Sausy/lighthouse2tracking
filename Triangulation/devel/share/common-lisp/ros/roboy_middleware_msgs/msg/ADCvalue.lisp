...
(cl:defmethod cl:initialize-instance :after ((m <ADCvalue>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ADCvalue)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_middleware_msgs-msg:<ADCvalue> is deprecated: use roboy_middleware_msgs-msg:ADCvalue instead.")))
...
(cl:defmethod adc_value-val ((m <ADCvalue>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_middleware_msgs-msg:adc_value-val is deprecated.  Use roboy_middleware_msgs-msg:adc_value instead.")
  (adc_value m))

(cl:ensure-generic-function 'load-val :lambda-list '(m))
(cl:defmethod load-val ((m <ADCvalue>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_middleware_msgs-msg:load-val is deprecated.  Use roboy_middleware_msgs-msg:load instead.")
  (load m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ADCvalue>)))
  ...
  "roboy_middleware_msgs/ADCvalue")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ADCvalue)))
  "Returns string type for a message object of type 'ADCvalue"
  "roboy_middleware_msgs/ADCvalue")
