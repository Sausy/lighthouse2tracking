...
(cl:defmethod cl:initialize-instance :after ((m <ControllerState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ControllerState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_middleware_msgs-msg:<ControllerState> is deprecated: use roboy_middleware_msgs-msg:ControllerState instead.")))
...
(cl:defmethod state-val ((m <ControllerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_middleware_msgs-msg:state-val is deprecated.  Use roboy_middleware_msgs-msg:state instead.")
  (state m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ControllerState>)))
  ...
  "roboy_middleware_msgs/ControllerState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ControllerState)))
  "Returns string type for a message object of type 'ControllerState"
  "roboy_middleware_msgs/ControllerState")
