...
(cl:defmethod cl:initialize-instance :after ((m <LighthousePoseCorrection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LighthousePoseCorrection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_middleware_msgs-msg:<LighthousePoseCorrection> is deprecated: use roboy_middleware_msgs-msg:LighthousePoseCorrection instead.")))
...
(cl:defmethod type-val ((m <LighthousePoseCorrection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_middleware_msgs-msg:type-val is deprecated.  Use roboy_middleware_msgs-msg:type instead.")
  (type m))

(cl:ensure-generic-function 'tf-val :lambda-list '(m))
(cl:defmethod tf-val ((m <LighthousePoseCorrection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_middleware_msgs-msg:tf-val is deprecated.  Use roboy_middleware_msgs-msg:tf instead.")
  (tf m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LighthousePoseCorrection>)))
  ...
  "roboy_middleware_msgs/LighthousePoseCorrection")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LighthousePoseCorrection)))
  "Returns string type for a message object of type 'LighthousePoseCorrection"
  "roboy_middleware_msgs/LighthousePoseCorrection")
