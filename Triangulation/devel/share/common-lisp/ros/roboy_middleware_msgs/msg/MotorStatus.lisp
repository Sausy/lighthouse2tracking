...
(cl:defmethod cl:initialize-instance :after ((m <MotorStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_middleware_msgs-msg:<MotorStatus> is deprecated: use roboy_middleware_msgs-msg:MotorStatus instead.")))
...
(cl:ensure-generic-function 'pwm_ref-val :lambda-list '(m))
(cl:defmethod pwm_ref-val ((m <MotorStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_middleware_msgs-msg:pwm_ref-val is deprecated.  Use roboy_middleware_msgs-msg:pwm_ref instead.")
  (pwm_ref m))
...
(cl:defmethod velocity-val ((m <MotorStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_middleware_msgs-msg:velocity-val is deprecated.  Use roboy_middleware_msgs-msg:velocity instead.")
  (velocity m))
...
(cl:defmethod angle-val ((m <MotorStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_middleware_msgs-msg:angle-val is deprecated.  Use roboy_middleware_msgs-msg:angle instead.")
  (angle m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MotorStatus>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'pwm_ref))))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MotorStatus>) istream)
  ...
  (cl:setf (cl:slot-value msg 'pwm_ref) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'pwm_ref)))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MotorStatus>)))
  ...
  (cl:format cl:nil "uint8 id~%bool power_sense~%int32[] pwm_ref~%int32[] position~%int32[] velocity~%int32[] displacement~%int16[] current~%# only available for myoBricks~%int32[] angle~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MotorStatus)))
  "Returns full string definition for message of type 'MotorStatus"
  (cl:format cl:nil "uint8 id~%bool power_sense~%int32[] pwm_ref~%int32[] position~%int32[] velocity~%int32[] displacement~%int16[] current~%# only available for myoBricks~%int32[] angle~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <MotorStatus>))
  (cl:+ 0
     1
     1
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'pwm_ref) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
