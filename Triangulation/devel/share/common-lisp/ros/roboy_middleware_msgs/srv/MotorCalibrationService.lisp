...
(cl:defmethod cl:initialize-instance :after ((m <MotorCalibrationService-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorCalibrationService-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_middleware_msgs-srv:<MotorCalibrationService-request> is deprecated: use roboy_middleware_msgs-srv:MotorCalibrationService-request instead.")))
...
(cl:defmethod number_of_data_points-val ((m <MotorCalibrationService-request>))
...
(cl:defmethod displacement_min-val ((m <MotorCalibrationService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_middleware_msgs-srv:displacement_min-val is deprecated.  Use roboy_middleware_msgs-srv:displacement_min instead.")
  (displacement_min m))
...
(cl:defmethod displacement_max-val ((m <MotorCalibrationService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_middleware_msgs-srv:displacement_max-val is deprecated.  Use roboy_middleware_msgs-srv:displacement_max instead.")
  (displacement_max m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MotorCalibrationService-request>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'number_of_data_points)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MotorCalibrationService-request>) istream)
  "Deserializes a message object of type '<MotorCalibrationService-request>"
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'number_of_data_points) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MotorCalibrationService-request>)))
  ...
  "roboy_middleware_msgs/MotorCalibrationServiceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MotorCalibrationService-request)))
  "Returns string type for a service object of type 'MotorCalibrationService-request"
  "roboy_middleware_msgs/MotorCalibrationServiceRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MotorCalibrationService-request>)))
  ...
  "892408477819859495b143dca33ce42a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MotorCalibrationService-request)))
  "Returns md5sum for a message object of type 'MotorCalibrationService-request"
  "892408477819859495b143dca33ce42a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MotorCalibrationService-request>)))
  ...
  (cl:format cl:nil "int32 fpga~%int32 motor~%int32 degree~%int32 timeout~%int32 number_of_data_points~%int32 displacement_min~%int32 displacement_max~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MotorCalibrationService-request)))
  "Returns full string definition for message of type 'MotorCalibrationService-request"
  (cl:format cl:nil "int32 fpga~%int32 motor~%int32 degree~%int32 timeout~%int32 number_of_data_points~%int32 displacement_min~%int32 displacement_max~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <MotorCalibrationService-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorCalibrationService-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_middleware_msgs-srv:<MotorCalibrationService-response> is deprecated: use roboy_middleware_msgs-srv:MotorCalibrationService-response instead.")))
...
(cl:defmethod load-val ((m <MotorCalibrationService-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_middleware_msgs-srv:load-val is deprecated.  Use roboy_middleware_msgs-srv:load instead.")
  (load m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MotorCalibrationService-response>)))
  ...
  "roboy_middleware_msgs/MotorCalibrationServiceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MotorCalibrationService-response)))
  "Returns string type for a service object of type 'MotorCalibrationService-response"
  "roboy_middleware_msgs/MotorCalibrationServiceResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MotorCalibrationService)))
  ...
  "roboy_middleware_msgs/MotorCalibrationService")