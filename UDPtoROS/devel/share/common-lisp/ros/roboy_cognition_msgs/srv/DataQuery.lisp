...
(cl:defmethod cl:initialize-instance :after ((m <DataQuery-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DataQuery-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_cognition_msgs-srv:<DataQuery-request> is deprecated: use roboy_cognition_msgs-srv:DataQuery-request instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <DataQuery-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_cognition_msgs-srv:header-val is deprecated.  Use roboy_cognition_msgs-srv:header instead.")
  (header m))

(cl:ensure-generic-function 'payload-val :lambda-list '(m))
(cl:defmethod payload-val ((m <DataQuery-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_cognition_msgs-srv:payload-val is deprecated.  Use roboy_cognition_msgs-srv:payload instead.")
  (payload m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DataQuery-request>)))
  ...
  "roboy_cognition_msgs/DataQueryRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DataQuery-request)))
  "Returns string type for a service object of type 'DataQuery-request"
  "roboy_cognition_msgs/DataQueryRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <DataQuery-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DataQuery-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_cognition_msgs-srv:<DataQuery-response> is deprecated: use roboy_cognition_msgs-srv:DataQuery-response instead.")))

(cl:ensure-generic-function 'answer-val :lambda-list '(m))
(cl:defmethod answer-val ((m <DataQuery-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_cognition_msgs-srv:answer-val is deprecated.  Use roboy_cognition_msgs-srv:answer instead.")
  (answer m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DataQuery-response>)))
  ...
  "roboy_cognition_msgs/DataQueryResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DataQuery-response)))
  "Returns string type for a service object of type 'DataQuery-response"
  "roboy_cognition_msgs/DataQueryResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DataQuery)))
  ...
  "roboy_cognition_msgs/DataQuery")