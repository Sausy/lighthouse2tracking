...
(cl:defmethod cl:initialize-instance :after ((m <FindInstances-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FindInstances-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_cognition_msgs-srv:<FindInstances-request> is deprecated: use roboy_cognition_msgs-srv:FindInstances-request instead.")))
...
(cl:defmethod value-val ((m <FindInstances-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_cognition_msgs-srv:value-val is deprecated.  Use roboy_cognition_msgs-srv:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FindInstances-request>)))
  ...
  "roboy_cognition_msgs/FindInstancesRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FindInstances-request)))
  "Returns string type for a service object of type 'FindInstances-request"
  "roboy_cognition_msgs/FindInstancesRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <FindInstances-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FindInstances-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_cognition_msgs-srv:<FindInstances-response> is deprecated: use roboy_cognition_msgs-srv:FindInstances-response instead.")))

(cl:ensure-generic-function 'instances-val :lambda-list '(m))
(cl:defmethod instances-val ((m <FindInstances-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_cognition_msgs-srv:instances-val is deprecated.  Use roboy_cognition_msgs-srv:instances instead.")
  (instances m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FindInstances-response>)))
  ...
  "roboy_cognition_msgs/FindInstancesResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FindInstances-response)))
  "Returns string type for a service object of type 'FindInstances-response"
  "roboy_cognition_msgs/FindInstancesResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FindInstances)))
  ...
  "roboy_cognition_msgs/FindInstances")