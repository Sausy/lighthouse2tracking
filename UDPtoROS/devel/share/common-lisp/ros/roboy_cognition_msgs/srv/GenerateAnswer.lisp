...
(cl:defmethod cl:initialize-instance :after ((m <GenerateAnswer-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GenerateAnswer-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_cognition_msgs-srv:<GenerateAnswer-request> is deprecated: use roboy_cognition_msgs-srv:GenerateAnswer-request instead.")))

(cl:ensure-generic-function 'text_input-val :lambda-list '(m))
(cl:defmethod text_input-val ((m <GenerateAnswer-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_cognition_msgs-srv:text_input-val is deprecated.  Use roboy_cognition_msgs-srv:text_input instead.")
  (text_input m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GenerateAnswer-request>)))
  ...
  "roboy_cognition_msgs/GenerateAnswerRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GenerateAnswer-request)))
  "Returns string type for a service object of type 'GenerateAnswer-request"
  "roboy_cognition_msgs/GenerateAnswerRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GenerateAnswer-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GenerateAnswer-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_cognition_msgs-srv:<GenerateAnswer-response> is deprecated: use roboy_cognition_msgs-srv:GenerateAnswer-response instead.")))
...
(cl:defmethod text_output-val ((m <GenerateAnswer-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_cognition_msgs-srv:text_output-val is deprecated.  Use roboy_cognition_msgs-srv:text_output instead.")
  (text_output m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GenerateAnswer-response>)))
  ...
  "roboy_cognition_msgs/GenerateAnswerResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GenerateAnswer-response)))
  "Returns string type for a service object of type 'GenerateAnswer-response"
  "roboy_cognition_msgs/GenerateAnswerResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GenerateAnswer)))
  ...
  "roboy_cognition_msgs/GenerateAnswer")