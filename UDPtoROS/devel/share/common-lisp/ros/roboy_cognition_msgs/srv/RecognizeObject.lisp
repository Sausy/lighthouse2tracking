...
(cl:defmethod cl:initialize-instance :after ((m <RecognizeObject-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RecognizeObject-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_cognition_msgs-srv:<RecognizeObject-request> is deprecated: use roboy_cognition_msgs-srv:RecognizeObject-request instead.")))

(cl:ensure-generic-function 'object_id-val :lambda-list '(m))
(cl:defmethod object_id-val ((m <RecognizeObject-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_cognition_msgs-srv:object_id-val is deprecated.  Use roboy_cognition_msgs-srv:object_id instead.")
  (object_id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RecognizeObject-request>)))
  ...
  "roboy_cognition_msgs/RecognizeObjectRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RecognizeObject-request)))
  "Returns string type for a service object of type 'RecognizeObject-request"
  "roboy_cognition_msgs/RecognizeObjectRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <RecognizeObject-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RecognizeObject-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_cognition_msgs-srv:<RecognizeObject-response> is deprecated: use roboy_cognition_msgs-srv:RecognizeObject-response instead.")))

(cl:ensure-generic-function 'object_name-val :lambda-list '(m))
(cl:defmethod object_name-val ((m <RecognizeObject-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_cognition_msgs-srv:object_name-val is deprecated.  Use roboy_cognition_msgs-srv:object_name instead.")
  (object_name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RecognizeObject-response>)))
  ...
  "roboy_cognition_msgs/RecognizeObjectResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RecognizeObject-response)))
  "Returns string type for a service object of type 'RecognizeObject-response"
  "roboy_cognition_msgs/RecognizeObjectResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RecognizeObject)))
  ...
  "roboy_cognition_msgs/RecognizeObject")