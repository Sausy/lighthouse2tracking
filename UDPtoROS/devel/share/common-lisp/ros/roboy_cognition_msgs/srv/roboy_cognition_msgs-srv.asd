...
(defsystem "roboy_cognition_msgs-srv"
  :depends-on (:roslisp-msg-protocol :roslisp-utils :geometry_msgs-msg
               :roboy_cognition_msgs-msg
)
  :components ((:file "_package")
    (:file "ApplyFilter" :depends-on ("_package_ApplyFilter"))
    (:file "_package_ApplyFilter" :depends-on ("_package"))
    ...
    (:file "DetectIceCream" :depends-on ("_package_DetectIceCream"))
    (:file "_package_DetectIceCream" :depends-on ("_package"))
    (:file "DetectIntent" :depends-on ("_package_DetectIntent"))
    (:file "_package_DetectIntent" :depends-on ("_package"))
    (:file "DriveToLocation" :depends-on ("_package_DriveToLocation"))
    (:file "_package_DriveToLocation" :depends-on ("_package"))
    ...
    (:file "LocalizeObject" :depends-on ("_package_LocalizeObject"))
    (:file "_package_LocalizeObject" :depends-on ("_package"))
    (:file "LookAtSpeaker" :depends-on ("_package_LookAtSpeaker"))
    (:file "_package_LookAtSpeaker" :depends-on ("_package"))
    (:file "Payment" :depends-on ("_package_Payment"))
    (:file "_package_Payment" :depends-on ("_package"))
    ...
    (:file "RecognizeFaces" :depends-on ("_package_RecognizeFaces"))
    (:file "_package_RecognizeFaces" :depends-on ("_package"))
