...
(cl:defmethod cl:initialize-instance :after ((m <InfoNotification>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'InfoNotification)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_control_msgs-msg:<InfoNotification> is deprecated: use roboy_control_msgs-msg:InfoNotification instead.")))
...
(cl:defmethod validity_duration-val ((m <InfoNotification>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<InfoNotification>)))
  ...
  "roboy_control_msgs/InfoNotification")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'InfoNotification)))
  "Returns string type for a message object of type 'InfoNotification"
  "roboy_control_msgs/InfoNotification")
