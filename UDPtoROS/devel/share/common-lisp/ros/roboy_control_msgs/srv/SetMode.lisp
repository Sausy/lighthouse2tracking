...
(cl:defmethod cl:initialize-instance :after ((m <SetMode-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetMode-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_control_msgs-srv:<SetMode-request> is deprecated: use roboy_control_msgs-srv:SetMode-request instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <SetMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_control_msgs-srv:id-val is deprecated.  Use roboy_control_msgs-srv:id instead.")
  (id m))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <SetMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_control_msgs-srv:mode-val is deprecated.  Use roboy_control_msgs-srv:mode instead.")
  (mode m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetMode-request>)))
  ...
  "roboy_control_msgs/SetModeRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetMode-request)))
  "Returns string type for a service object of type 'SetMode-request"
  "roboy_control_msgs/SetModeRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetMode-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetMode-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_control_msgs-srv:<SetMode-response> is deprecated: use roboy_control_msgs-srv:SetMode-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetMode-response>)))
  ...
  "roboy_control_msgs/SetModeResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetMode-response)))
  "Returns string type for a service object of type 'SetMode-response"
  "roboy_control_msgs/SetModeResponse")
