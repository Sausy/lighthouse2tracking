...
(cl:defmethod cl:initialize-instance :after ((m <ExternalForce>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExternalForce)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_simulation_msgs-msg:<ExternalForce> is deprecated: use roboy_simulation_msgs-msg:ExternalForce instead.")))
...
(cl:defmethod x-val ((m <ExternalForce>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_simulation_msgs-msg:x-val is deprecated.  Use roboy_simulation_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <ExternalForce>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_simulation_msgs-msg:y-val is deprecated.  Use roboy_simulation_msgs-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <ExternalForce>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_simulation_msgs-msg:z-val is deprecated.  Use roboy_simulation_msgs-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'f_x-val :lambda-list '(m))
(cl:defmethod f_x-val ((m <ExternalForce>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_simulation_msgs-msg:f_x-val is deprecated.  Use roboy_simulation_msgs-msg:f_x instead.")
  (f_x m))

(cl:ensure-generic-function 'f_y-val :lambda-list '(m))
(cl:defmethod f_y-val ((m <ExternalForce>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_simulation_msgs-msg:f_y-val is deprecated.  Use roboy_simulation_msgs-msg:f_y instead.")
  (f_y m))

(cl:ensure-generic-function 'f_z-val :lambda-list '(m))
(cl:defmethod f_z-val ((m <ExternalForce>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_simulation_msgs-msg:f_z-val is deprecated.  Use roboy_simulation_msgs-msg:f_z instead.")
  (f_z m))

(cl:ensure-generic-function 'duration-val :lambda-list '(m))
(cl:defmethod duration-val ((m <ExternalForce>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_simulation_msgs-msg:duration-val is deprecated.  Use roboy_simulation_msgs-msg:duration instead.")
  (duration m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ExternalForce>)))
  ...
  "roboy_simulation_msgs/ExternalForce")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ExternalForce)))
  "Returns string type for a message object of type 'ExternalForce"
  "roboy_simulation_msgs/ExternalForce")
