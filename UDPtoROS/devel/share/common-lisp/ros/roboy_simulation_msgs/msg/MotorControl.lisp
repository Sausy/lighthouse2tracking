...
(cl:defmethod cl:initialize-instance :after ((m <MotorControl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorControl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_simulation_msgs-msg:<MotorControl> is deprecated: use roboy_simulation_msgs-msg:MotorControl instead.")))

(cl:ensure-generic-function 'roboy_id-val :lambda-list '(m))
(cl:defmethod roboy_id-val ((m <MotorControl>))
...
(cl:defmethod voltage-val ((m <MotorControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_simulation_msgs-msg:voltage-val is deprecated.  Use roboy_simulation_msgs-msg:voltage instead.")
  (voltage m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MotorControl>)))
  ...
  "roboy_simulation_msgs/MotorControl")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MotorControl)))
  "Returns string type for a message object of type 'MotorControl"
  "roboy_simulation_msgs/MotorControl")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MotorControl>)))
  ...
  "4caa04c8853715c70c56574cffce69ce")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MotorControl)))
  "Returns md5sum for a message object of type 'MotorControl"
  "4caa04c8853715c70c56574cffce69ce")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MotorControl>)))
  ...
  (cl:format cl:nil "int32 roboy_id~%float32[] voltage~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MotorControl)))
  "Returns full string definition for message of type 'MotorControl"
  (cl:format cl:nil "int32 roboy_id~%float32[] voltage~%~%"))
