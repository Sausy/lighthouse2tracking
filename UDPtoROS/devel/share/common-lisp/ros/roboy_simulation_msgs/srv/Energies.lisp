...
(cl:defmethod cl:initialize-instance :after ((m <Energies-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Energies-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_simulation_msgs-srv:<Energies-request> is deprecated: use roboy_simulation_msgs-srv:Energies-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Energies-request>)))
  ...
  "roboy_simulation_msgs/EnergiesRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Energies-request)))
  "Returns string type for a service object of type 'Energies-request"
  "roboy_simulation_msgs/EnergiesRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Energies-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Energies-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_simulation_msgs-srv:<Energies-response> is deprecated: use roboy_simulation_msgs-srv:Energies-response instead.")))

(cl:ensure-generic-function 'E_speed-val :lambda-list '(m))
(cl:defmethod E_speed-val ((m <Energies-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_simulation_msgs-srv:E_speed-val is deprecated.  Use roboy_simulation_msgs-srv:E_speed instead.")
  (E_speed m))

(cl:ensure-generic-function 'E_headvel-val :lambda-list '(m))
(cl:defmethod E_headvel-val ((m <Energies-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_simulation_msgs-srv:E_headvel-val is deprecated.  Use roboy_simulation_msgs-srv:E_headvel instead.")
  (E_headvel m))

(cl:ensure-generic-function 'E_headori-val :lambda-list '(m))
(cl:defmethod E_headori-val ((m <Energies-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_simulation_msgs-srv:E_headori-val is deprecated.  Use roboy_simulation_msgs-srv:E_headori instead.")
  (E_headori m))

(cl:ensure-generic-function 'E_slide-val :lambda-list '(m))
(cl:defmethod E_slide-val ((m <Energies-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_simulation_msgs-srv:E_slide-val is deprecated.  Use roboy_simulation_msgs-srv:E_slide instead.")
  (E_slide m))

(cl:ensure-generic-function 'E_effort-val :lambda-list '(m))
(cl:defmethod E_effort-val ((m <Energies-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_simulation_msgs-srv:E_effort-val is deprecated.  Use roboy_simulation_msgs-srv:E_effort instead.")
  (E_effort m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Energies-response>)))
  ...
  "roboy_simulation_msgs/EnergiesResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Energies-response)))
  "Returns string type for a service object of type 'Energies-response"
  "roboy_simulation_msgs/EnergiesResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Energies)))
  ...
  "roboy_simulation_msgs/Energies")