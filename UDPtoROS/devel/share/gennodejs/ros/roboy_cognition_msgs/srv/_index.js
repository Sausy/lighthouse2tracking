...
let QualityOfTone = require('./QualityOfTone.js')
...
let WhichTones = require('./WhichTones.js')
let CallQuery = require('./CallQuery.js')
let QualityOfTones = require('./QualityOfTones.js')
...
let ApplyFilter = require('./ApplyFilter.js')
let DetectFace = require('./DetectFace.js')
let Payment = require('./Payment.js')
let RecognizeFaces = require('./RecognizeFaces.js')
...
let DriveToLocation = require('./DriveToLocation.js')
let ShowProperty = require('./ShowProperty.js')
let PlaySound = require('./PlaySound.js')
let GetObject = require('./GetObject.js')

module.exports = {
  QualityOfTone: QualityOfTone,
  GenerateAnswer: GenerateAnswer,
  ShowInstances: ShowInstances,
  SaveObject: SaveObject,
  WhichTones: WhichTones,
  CallQuery: CallQuery,
  QualityOfTones: QualityOfTones,
