...
class LookAtActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LookAtGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += LookAtGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LookAtActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = LookAtGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new LookAtGoal()
    }
...
module.exports = LookAtActionGoal;
