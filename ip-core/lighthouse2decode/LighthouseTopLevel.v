...
//BufferCC_5_ remplaced by BufferCC_3_


//BufferCC_6_ remplaced by BufferCC_3_


//BufferCC_7_ remplaced by BufferCC_3_


//BufferCC_8_ remplaced by BufferCC_3_
...
module StreamCCByToggle (
  ...
  assign _zz_1_ = 1'b0;
  assign pushArea_hit = bufferCC_12__io_dataOut;
  always @ (*) begin
    io_input_ready = 1'b0;
    if(_zz_3_)begin
      io_input_ready = 1'b1;
  ...
  assign _zz_2_ = 1'b0;
  assign popArea_target = bufferCC_13__io_dataOut;
...
module StreamArbiter (
  ...
  assign io_output_payload_pulse_width = io_inputs_0_payload_pulse_width;
  assign io_output_payload_pulse_timestamp = io_inputs_0_payload_pulse_timestamp;
  assign io_output_payload_beamWord = io_inputs_0_payload_beamWord;
...
module LighthouseTopLevel (
  ...
  wire  _zz_28_;
  wire [2:0] _zz_29_;
  wire `UartStopType_defaultEncoding_type _zz_30_;
  wire `UartParityType_defaultEncoding_type _zz_31_;
  wire [19:0] _zz_32_;
  wire [7:0] _zz_33_;
  wire  _zz_34_;
  wire  _zz_35_;
  ...
  assign _zz_40_ = ((1'b1 && (! _zz_5_)) || _zz_6_);
  assign _zz_41_ = slowArea_ledControl[1 : 0];
  assign _zz_42_ = slowArea_ledControl[3 : 2];
  assign _zz_43_ = slowArea_ledControl[5 : 4];
  assign _zz_44_ = slowArea_syncTimeout_counter_willIncrement;
  assign _zz_45_ = {23'd0, _zz_44_};
  assign _zz_46_ = _zz_13_;
  assign _zz_47_ = {3'd0, _zz_46_};
  assign _zz_48_ = slowArea_slowBlinkTimer_counter_willIncrement;
  assign _zz_49_ = {23'd0, _zz_48_};
  assign _zz_50_ = slowArea_fastBlinkTimer_counter_willIncrement;
  assign _zz_51_ = {21'd0, _zz_50_};
  /*pll clkCtrl_pll (
  ...
  BufferCC_3_ bufferCC_15_ (
    .io_dataIn(d_oe_0),
    .io_dataOut(bufferCC_15__io_dataOut),
    .Core_clk(Core_clk)
  );
  BufferCC_3_ bufferCC_16_ (
    .io_dataIn(d_out_0),
    .io_dataOut(bufferCC_16__io_dataOut),
    .Core_clk(Core_clk)
  );
  BufferCC_3_ bufferCC_17_ (
    .io_dataIn(d_out_0),
  ...
  UartCtrl slowArea_uartCtrl (
    .io_config_frame_dataLength(_zz_29_),
    .io_config_frame_stop(_zz_30_),
    .io_config_frame_parity(_zz_31_),
    .io_config_clockDivider(_zz_32_),
    .io_write_valid(io_output_fifo_1__io_pop_valid),
    .io_write_ready(slowArea_uartCtrl_io_write_ready),
    .io_write_payload(_zz_33_),
  ...
  StreamFifo_1_ io_output_fifo_1_ (
  ...
  always @(*) begin
    case(_zz_15_)
      ...
      4'b0001 : begin
        _zz_39_ = _zz_18_[15 : 8];
      end
      4'b0010 : begin
        _zz_39_ = _zz_18_[23 : 16];
      end
      4'b0011 : begin
        _zz_39_ = _zz_18_[31 : 24];
      end
      4'b0100 : begin
        _zz_39_ = _zz_18_[39 : 32];
      end
      4'b0101 : begin
        _zz_39_ = _zz_18_[47 : 40];
      end
      4'b0110 : begin
        _zz_39_ = _zz_18_[55 : 48];
      end
      4'b0111 : begin
        _zz_39_ = _zz_18_[63 : 56];
      end
      4'b1000 : begin
        _zz_39_ = _zz_18_[71 : 64];
      end
      4'b1001 : begin
        _zz_39_ = _zz_18_[79 : 72];
      end
      4'b1010 : begin
        _zz_39_ = _zz_18_[87 : 80];
      end
      default : begin
        _zz_39_ = _zz_18_[95 : 88];
      end
    endcase
  end

  assign Core_clk = io_clk48MHz;//clkCtrl_pll_clock_out;
  ...
  assign slowArea_idBeamWords_0_valid = _zz_12_;
  assign slowArea_idBeamWords_0_payload_id = (2'b00);
  assign slowArea_idBeamWords_0_payload_pulse_width = pulseTimer_1__io_pulse_payload_width;
  assign slowArea_idBeamWords_0_payload_pulse_timestamp = pulseTimer_1__io_pulse_payload_timestamp;
  assign slowArea_idBeamWords_0_payload_beamWord = _zz_11_;
  ...
  always @ (*) begin
    if(slowArea_syncTimeout_counter_willOverflow)begin
      ...
      slowArea_syncTimeout_counter_valueNext = (slowArea_syncTimeout_counter_value + _zz_45_);
    end
  ...
  assign _zz_32_ = (20'b00000000000000001100);
  assign _zz_29_ = (3'b111);
  assign _zz_31_ = `UartParityType_defaultEncoding_NONE;
  assign _zz_30_ = `UartStopType_defaultEncoding_ONE;
  ...
  assign _zz_16_ = (_zz_15_ == (4'b1011));
  assign _zz_17_ = (_zz_16_ && _zz_13_);
  always @ (*) begin
    if(_zz_17_)begin
      _zz_14_ = (4'b0000);
    end else begin
      _zz_14_ = (_zz_15_ + _zz_47_);
    end
    if(1'b0)begin
      _zz_14_ = (4'b0000);
    end
  ...
  assign _zz_18_ = io_output_fifo_1__io_pop_payload;
  assign _zz_33_ = _zz_39_;
  assign _zz_34_ = (slowArea_uartCtrl_io_write_ready && _zz_16_);
  always @ (*) begin
  ...
  always @ (*) begin
    if(slowArea_slowBlinkTimer_counter_willOverflow)begin
      ...
      slowArea_slowBlinkTimer_counter_valueNext = (slowArea_slowBlinkTimer_counter_value + _zz_49_);
    end
  ...
  always @ (*) begin
    if(slowArea_fastBlinkTimer_counter_willOverflow)begin
      ...
      slowArea_fastBlinkTimer_counter_valueNext = (slowArea_fastBlinkTimer_counter_value + _zz_51_);
    end
  ...
  always @ (*) begin
    ...
    case(_zz_41_)
      ...
      2'b01 : begin
        _zz_19_ = slowArea_slowBlink;
      end
      2'b10 : begin
        _zz_19_ = slowArea_fastBlink;
      end
      default : begin
        _zz_19_ = 1'b1;
      end
  ...
  always @ (*) begin
    ...
    case(_zz_42_)
      ...
      2'b01 : begin
        _zz_20_ = slowArea_slowBlink;
      end
      2'b10 : begin
        _zz_20_ = slowArea_fastBlink;
      end
      default : begin
        _zz_20_ = 1'b1;
      end
  ...
  always @ (*) begin
    ...
    case(_zz_43_)
      ...
      2'b01 : begin
        _zz_21_ = slowArea_slowBlink;
      end
      2'b10 : begin
        _zz_21_ = slowArea_fastBlink;
      end
      default : begin
        _zz_21_ = 1'b1;
      end
  ...
  assign io_led2 = (! _zz_21_);
  assign _zz_38_ = 1'b0;
  assign _zz_37_ = 1'b0;
  assign _zz_36_ = (slowArea_resetControl == (8'b11001111));
  assign _zz_28_ = 1'b0;
  assign _zz_35_ = 1'b0;
  always @ (posedge Core_clk) begin
